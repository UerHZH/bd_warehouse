...
class HexNut(Nut):
    ...
    Args:
        size (str): size specification, e.g. "M6-1"
        fastener_type (Literal["iso4032", "iso4033", "iso4035", 'jisb1181', 'din439', 'iso4032', 'din934', 'ansib18.2.2', 'gb6170'], optional):
            Defaults to "iso4032".
    ...
    def __init__(
        self,
        size: str,
        fastener_type: Literal["iso4032", "iso4033", "iso4035", 'jisb1181', 'din439', 'iso4032', 'din934', 'ansib18.2.2', 'gb6170'] = "iso4032",
        hand: Literal["right", "left"] = "right",
        simple: bool = False,
        rotation: RotationLike = (0, 0, 0),
        align: Union[None, Align, tuple[Align, Align, Align]] = None,
